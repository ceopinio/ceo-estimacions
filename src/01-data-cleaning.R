...
bop <- read_sav(file.path(RAW_DTA_FOLDER, "Microdades_anonimitzades_1071.sav")) # (Data downloaded from website) CEOdata R package can also be used
...
bop <- bop |>
  ...
  select("id",
         ...
         "SIT_POL_CAT",
         "SIT_ECO_ESP",
         "SIT_ECO_ESP_PROSPECTIVA", # Added BOP1-2024
         "SIT_POL_ESP",
         "SATIS_DEMOCRACIA",
         "INTERES_POL_PUBLICS",
         "INF_POL_DIARI_FREQ",
         ...
         "PART_ELECCIONS",
         "INF_POL_OBJ_COMICIS",
         "INF_POL_OBJ_CONSELLER_PARLAMENT", 
         "INF_POL_OBJ_ESCONS_CONGRES",
         "INF_POL_OBJ_ESCONS_PARLAMENT", 
         "INF_POL_OBJ_MINISTRE_CONGRES",
         "estudis_1_5",
         "ingressos_1_5",
         "PROVINCIA", 
         "HABITAT", 
